 ...
 * 
 * This is a safety value. If your extruder temperature is below this
 * temperature, no extruder steps are executed. This is to prevent your extruder
 ...
 *
 * Linear is the dominant value, so no real need to activate the quadratic term.
 * Only adds lots of computations and storage usage. 
 *
 * 0 = disallow a quadratic advance dependency. 
 * 1 = allow
 *
 */
